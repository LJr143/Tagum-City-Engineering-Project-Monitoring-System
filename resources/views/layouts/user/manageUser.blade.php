...
<x-app-layout mainClass="flex" headerClass="shadow-[0px_1px_2px_-1px_rgba(0,0,0,0.1)] ">
    ...
    <x-slot name="main">
        ...
        <!-- Add User Modal -->
        <div id="add-user-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 sm:p-6 lg:p-8 hidden">
            <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
                <div class="flex justify-between items-center mb-4">
                    <h2 class="text-sm font-semibold">Add User</h2>
                ...
                <form id="add-user-form">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <div class="relative">
                                <input type="date" id="birthdate" class="w-full mt-1 p-2 border rounded-md text-sm" placeholder="MM/DD/YYYY" onchange="calculateAge()">
                        ...
                        <div>
                            ...
                            <input type="text" id="age" class="w-full mt-1 p-2 border rounded-md text-sm" placeholder="Age" readonly>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                        <div>
                            <label class="block text-gray-700 text-sm">Position</label>
                            <select id="position" class="w-full mt-1 p-2 border rounded-md mb-4 text-sm">
                        ...
                        <div>
                            ...
                            <select id="role" class="w-full mt-1 p-2 border rounded-md mb-4 text-sm">
