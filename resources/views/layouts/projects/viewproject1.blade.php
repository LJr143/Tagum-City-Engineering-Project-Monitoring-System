    ...
    <x-slot name="main">
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-between mb-4">
                        ...
                        <div class="flex space-x-4">
                            ...
                            @if ($project->status === 'pending validation')
                               <livewire:manage-approval-denial :project="$project"/>
        ...
        <div id="delete-modal" class="fixed inset-0 flex items-center  justify-center bg-black bg-opacity-50 hidden z-50">
            <div class="bg-white rounded-lg shadow-lg p-4 sm:p-6 w-full max-w-xs sm:max-w-md md:w-1/3 mx-2">
                ...
                <p class="text-xs sm:text-[12px] mb-4 ml-7">Are you sure you want to delete this project? This action cannot be undone.</p>
                <div class="flex justify-end sm:text-[12px]">
                    <button id="delete-cancel-button" onclick="closeDeleteModal()"
                            class="bg-white border border-gray-300 text-gray-700 rounded-md text-[12px] sm:text-[12px] px-3 py-2 sm:px-4 hover:bg-gray-400">
                        Cancel
                    </button>
                    <form id="delete-form" action="{{ route('project.destroy', $project->id) }}" method="POST">
                        ...
                        @method('DELETE')
                        <button type="submit"
                                class="bg-red-500 text-white rounded-md px-3 py-2 sm:px-4 text-[12px] sm:text-[12px] hover:bg-red-600 ml-2">
                            Delete
                        </button>
                    </form>
                </div>
