                ...
                <div class="flex justify-end mb-4">
                    <div class="flex flex-col items-end space-y-2 w-full">
                        <div class="flex space-x-2">
                            ...
                            <!-- Delete Button -->
                            <button type="button" onclick="openDeleteModal()" class="flex bg-red-500 text-white text-xs px-4 py-2 rounded shadow-md hover:bg-red-600 focus:outline-none">
                                Delete Projectt
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 w-1/3">
                ...
                <div class="flex justify-end">
                    ...
                    <form id="delete-form" action="{{ route('project.destroy', $project->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="bg-red-500 text-white rounded-md px-4 py-2 text-xs hover:bg-red-600 ml-2">
                            Delete
                        </button>
                    </form>
                </div>
