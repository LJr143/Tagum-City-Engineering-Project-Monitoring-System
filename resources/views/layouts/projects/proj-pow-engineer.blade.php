    ...
    <x-slot name="main">
        ...
        <div class="flex-1 p-5">
            <main>
                ...
                <p class="text-xs ml-8  font-semibold">Address:
                ...
                <div class="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <div class="flex flex-col space-y-4 mx-8">
                        ...
                        <div class="flex justify-end mb-4">
                            <button id="add-card-button" class="bg-green-700 text-white mr-2 text-xs px-4 h-8 py-2 rounded shadow-md hover:bg-green-900 focus:outline-none">
                                Add New POW
                            </button>
                            <!-- Search bar -->
