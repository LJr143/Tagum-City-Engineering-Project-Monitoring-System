<x-app-layout mainClass="flex" headerClass="shadow-[0px_1px_2px_-1px_rgba(0,0,0,0.1)] ">
    ...
    <x-slot name="main">
        ...
        <div>
            ...
            <div x-data="{ startDate: '', endDate: '', filteredProjects: [] }" class="p-2">
                ...
                <div>
                    <template x-for="project in filteredProjects" :key="project.id">
                        <div class="mb-4 p-4 bg-white rounded-lg shadow">
                            <h2 class="text-xs font-semibold" x-text="project.title"></h2>
                            <p class="text-xs text-gray-500" x-text="project.date"></p>
                        </div>
                    </template>
                </div>
            </div>
            ...
            <script>
                function filterProjects() {
                    return {
                        ...
                        filteredProjects: [],
                        projects: [
                            { id: 1, title: 'Project 1', date: '2024-10-01' },
                            { id: 2, title: 'Project 2', date: '2024-10-05' },
                            { id: 3, title: 'Project 3', date: '2024-10-10' },
                            { id: 4, title: 'Project 4', date: '2024-10-15' }
                        ],
                        filterProjects() {
                            if (this.startDate && this.endDate) {
                                this.filteredProjects = this.projects.filter(project => {
                                    return project.date >= this.startDate && project.date <= this.endDate;
                                });
                            } else {
