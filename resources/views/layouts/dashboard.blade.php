        ...
        <div class="mt-8 w-full mx-auto bg-white p-6 rounded-lg shadow-md">
            ...
            <div class="overflow-x-auto bg-white shadow rounded-lg">
                <table class="min-w-full table-fixed divide-y divide-gray-300">
                    <thead>
                    <tr>
                        <th scope="col" class=" py-3.5 px-4 pr-3 text-left text-sm font-semibold text-gray-900">
                            Project Name
                        </th>
                        <th scope="col" class=" py-3.5 px-4 pr-3 text-left text-sm font-semibold text-gray-900">
                            Project Incharge
                    ...
                    @foreach($projects as $project)
                        <tr>
                            <td class=" py-1 px-4 pr-3 text-xs font-small text-gray-900">{{ $project->title }}</td>
                            <td class=" py-1 px-4 pr-3 text-xs font-small text-gray-900">{{ $project->projectIncharge->first_name }} {{ $project->projectIncharge->last_name }}</td>
                ...
                @else
                    {{-- Pagination Links --}}
                    <div class="flex flex-col md:flex-row w-full py-5 flex justify-center items-center">
