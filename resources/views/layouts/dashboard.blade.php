        ...
        <div class="mt-8">
            <div class="relative overflow-hidden rounded-lg bg-white px-4 pb-8 pt-5 shadow sm:px-6 sm:pt-6">
                ...
                <div class="mt-4 flex justify-end">
                    <a href="{{ route('project-main') }}" class="block rounded-md bg-green-600 px-3 py-1 text-center text-xs font-small text-white shadow-sm hover:bg-green-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">
                        View All
                    </a>
                </div>
                        ...
                        <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                            <div class="relative bg-white shadow rounded-lg">
                                <table class="min-w-full table-fixed divide-y divide-gray-300">
                                    <thead>
                                    <tr class="">
                                        <th scope="col" class="min-w-[12rem] py-3.5 px-4 pr-3 text-left text-sm font-semibold text-gray-900">Project Name</th>
                                    ...
                                    @foreach($projects as $project)
                                        <tr>
                                            ...
                                            <td class="whitespace-nowrap px-3 py-1 text-xs text-gray-500">Php {{$project->project_cost}}</td>
                                            ...
                                            <td class="whitespace-nowrap text-sm text-gray-500 text-center">
                                                     <span class="flex items-center justify-center text-center rounded-[5px] capitalize p-2 w-[150px] text-xs font-semibold leading-5 text-green-800 bg-green-100">
                                                            {{$project->status}}
                                                    </span>
                                            </td>
