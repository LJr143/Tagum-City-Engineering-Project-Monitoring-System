<div x-data="{ open: false, isUploading: @entangle('isUploading') }" x-cloak @pow-added.window="open = false" wire:ignore>
            ...
            selectEngineer(engineer) {
                ...
                return fullName.toLowerCase().includes(search.toLowerCase());
                    ...
                    <div class="flex gap-4">
                        <div class="w-1/2">
                            <div class="flex flex-col space-y-1">
                                <label for="total_project_cost" class="block text-gray-700 text-xs">Total Material
                                    Cost</label>
                                <input type="text" id="total_project_cost" wire:model="total_material_cost"
                                       class="mt-1 block w-full p-1 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-xs"
                                       required>
                            </div>
                        </div>
                    ...
                    <div>
                        <label for="total_labor_cost" class="block text-gray-700 text-xs">Upload Material</label>
                        <input type="file" wire:model="materialsFile" class="mt-1 block w-full p-1 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-xs">
                    </div>
                    <br>
