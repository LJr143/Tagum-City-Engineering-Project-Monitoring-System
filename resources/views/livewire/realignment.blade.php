<div>
    <form wire:submit.prevent="submitRealignment">
        ...
        @if($category_source)
            ...
            <select wire:model="category_source_item" id="category_source_item" class="select2 w-full border border-gray-300 rounded-md px-2 py-1 text-xs mb-4" required>
        ...
        <select wire:model="destination_category" id="destination_category" class="select2 w-full border border-gray-300 rounded-md px-2 py-1 text-xs mb-4" required>
        ...
        <div class="flex justify-end">
            <button type="button" wire:click="$emit('closeRealignmentModal')" class="bg-white border border-gray-300 text-gray-700 rounded-md text-xs px-4 py-2 hover:bg-gray-400">
                Cancel
            </button>
    ...
    <script>
        ...
        function initializeSelect2() {
            ...
            $('#category_source, #category_source_item, #destination_category, #destination_category_item').select2({
                width: '100%',
