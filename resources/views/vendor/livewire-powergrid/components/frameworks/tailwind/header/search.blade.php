@if (data_get($setUp, 'header.searchInput'))
    <div class="flex flex-row mt-3 md:mt-0 w-full rounded-full justify-start sm:justify-center md:justify-end">
        <div class="group relative rounded-full w-full float-end md:w-full lg:w-1/2">
{{--            extracted attributes: md:w-4/12, float-right--}}
            ...
            <input
                ...
                type="text"
                class="{{ data_get($theme, 'searchBox.inputClass') }} pl-8"
