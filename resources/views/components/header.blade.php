    ...
    <div class="flex items-center justify-end">
        <div class="flex justify-between items-center ml-24 mr-2 w-[50px]" >
            <svg width="45" height="45" viewBox="0 0 57 55" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect y="7" width="48" height="48" rx="15" fill="#2D9CDB" fill-opacity="0.15"/>
                ...
                <rect x="33.5" y="1.5" width="22" height="22" rx="11" fill="#2D9CDB" stroke="#F3F2F7" stroke-width="3"/>
            ...
            <svg width="1" height="35" viewBox="0 0 1 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="1" height="56" rx="0.5" fill="#D0D6DE"/>
            </svg>
        </div>

        <div class="flex justify-center items-center">
            <svg width="3" height="12" viewBox="0 0 3 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <line x1="1.5" y1="1.5" x2="1.5" y2="22.5" stroke="#FAC05E" stroke-width="3" stroke-linecap="round"/>
            </svg>

            <img class="w-[50px]" src="{{ asset('storage/pmsAssets/default.png') }}" alt="profile_img">

            <div class="block items-center">
                <p style="font-size: 12px">Juan Dela Cruz</p>
                <p style="font-size: 8px">Admin</p>
            </div>
